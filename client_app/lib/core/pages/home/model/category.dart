...
//  const Category('assets/icons/category_lamp@2x.png', 'Lamp', 'sofa'),
  ...
  const Category('assets/icons/accessoire.png', 'Accessories', 'sofa'),
  const Category('assets/icons/chaussures.png', 'Shoes', 'sofa'),
  const Category('assets/icons/clothes.png', 'Clothes', 'sofa'),
